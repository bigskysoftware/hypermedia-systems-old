...
to be called a Single Page Applications (SPAs).  Rather than navigating between pages, these web applications use
...
JSON APU, and have never learned about hypermedia at all.
