...
One such hypermedia oriented library is htmx (https://htmx.org), created by the authors of this book.  Htmx will be the
focus of Part Two.  We show that you can, in fact, create many common
