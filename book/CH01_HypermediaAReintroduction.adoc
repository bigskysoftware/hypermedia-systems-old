...
a plea that we "let The Web be The Web", that we take the original architecture of this amazing distributed system we
all use every day seriously, that we give _hypermedia systems_ a fair hearing.