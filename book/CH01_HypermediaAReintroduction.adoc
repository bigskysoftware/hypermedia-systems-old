...
// revised: it may be too much to suggest memorizing all tags 
// maybe: make underused or lesser known tags its own topic?
* A "command palette" menu?
* A play-pause button?
* A search field with a search button next to it? 
* A modal for alerts?
* A progress bar? 
****