...
using hypertext, to emphasize the system architecture over the particular hypermedia being used.  It is the entire
hypermedia system architecture that we feel is underappreciated in our industry.
...
of the web.  But the industry didn't.  Instead of pushing hypermedia forward, the industry, on the whole, chose
...
links and forms across multiple web pages.  These applications and are thus, by their nature, Hypermedia-Driven Applications.
...
But this compromise still feels a bit unsatisfactory.  Why have two very different architectural models _by default_?  Recall that the
