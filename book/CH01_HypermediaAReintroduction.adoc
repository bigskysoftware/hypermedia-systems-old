...
SPAs are much more like _thick client applications_, that is, like the client-server applications of the
...
Seriously? Are we claiming that modern web applications cannot be built using it?
