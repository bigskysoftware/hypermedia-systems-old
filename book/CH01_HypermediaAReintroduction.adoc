...
As someone interested in web development the above diagrams and discussion probably look very familiar.  You may
...
So `<a>` and `<form>` are the two main hypermedia-based mechanisms for interacting with a server available in HTML.
