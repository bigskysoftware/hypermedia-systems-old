...
"`Transitional`" is a good term for these mixed-style applications and offers a reasonable compromise between the two, using
...
Recall that the crux of the trade-offs between SPAs and MPAs is the _user experience_, or interactivity of the application.
...
focus of Part Two.  We hope to show you that you can, in fact, create many common
