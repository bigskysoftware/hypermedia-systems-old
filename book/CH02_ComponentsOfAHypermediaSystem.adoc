...
of the contact _encodes_ the state of the application (that is, exactly what can and cannot be done with this particular
...
An important fact falls out of this:  because of this flexibility, hypermedia APIs _do not have the versioning headaches
