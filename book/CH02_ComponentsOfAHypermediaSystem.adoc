...
representation.  Fielding notes exactly this trade-off when using a REST-ful architecture in his dissertation:
...
We called The Layered System constraint the final "`required`" constraint on a REST-ful system.  We used this language because
