...
For our next step with htmx, recall that our contact application has a small form on the edit page of a contact that is
...
Currently, our contacts application does not support paging: if there are 10,000 contacts in the database we will show
