...
With that done, viola: we get a nice, smooth progress bar as the contact archiving process proceeds.  Because of
...
The hyperscript reads nearly identical to that sentence (which is why we love hyperscript):
