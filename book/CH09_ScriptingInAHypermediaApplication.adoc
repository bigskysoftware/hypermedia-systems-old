...
Array property access:: ((("_hyperscript", "array property access")))
...
Native CSS Syntax:: ((("_hyperscript", "CSS syntax")))
...
Deep Event Support:: ((("_hyperscript", "event support")))
...
//TODO: keep this example of wrapping a function, but mention <dialog> tag?
(((SweetAlert2)))
...
-- Roy Fielding, https://www.slideshare.net/royfielding/a-little-rest-and-relaxation[A little REST and Relaxation]
...
[quote, Leah Clark, @leah@tilde.zone]
____
