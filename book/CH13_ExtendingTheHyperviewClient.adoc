...
//TODO astep: wt wrote a basic conclusion here, is it okay? add more?
...
[.design-note]
.HTML Notes: Three Tips
****
_Think Twice About Modals_

Modal windows have become popular, almost standard, in many web applications today.
...
As Roy Fielding said with respect to the web’s REST-ful network architecture:
...
_When Necessary, Create “'Islands of Interactivity'”_
...
Consider the SortableJS example. Here you have a sophisticated area of interactivity that allows for drag-and-drop, and that integrates with htmx and the broader hypermedia-driven application via events.
