...
OK, with that brief introduction to Flask out of the way, let's get down to brass tacks.  What will Contact.app do?
...
* A like to the "View" page for the contact `/contacts/{{ contact.id }}` (using our previous contact example, the show
...
We _can_ improve the user experience of this application _without_ abandoning the hypermedia architecture.
...
user experiences, all within the original, REST-ful architecture of the web.