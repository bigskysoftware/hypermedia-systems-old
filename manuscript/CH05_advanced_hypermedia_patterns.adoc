...
However, that isn't the only fix, and, in this case, isn't the most efficient one.  Instead, let's change the server-side
of our Hypermedia Driven Application to serve _only the HTML content needed_
